 ...
 *
 */
public class GRTS extends TrajectoryCompressor {

    int count = 0;

    public GRTS(DisCalculator dc) {
        super();
        this.setDc(dc);
    }
...
//        		}
            ...
            if (disOfP2P > Threshold) {
                System.out.println("����㳬������ֵ" + i + "qishidian" + Sstart);
...
//            	System.out.println(linesU.size());
    ...
    public static void main(String[] args) throws IOException {
        ...
        TrajectoryCompressor tc = new GRTS(sed);
